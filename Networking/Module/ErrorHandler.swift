...
@objc public  class ErrorHandler:NSObject {
...
//    private var activityIndicator: UIView?
    ...
    @objc public func showErrorAlert(_ errorType: ErrorType, withError error: Error?) {
...
//            }
    ...
    @objc public func showErrorAlert(_ errorType: ErrorType, withError error: Error?, withResponse response: [AnyHashable : Any]?) {
        if response == nil {
...
//    }
    ...
    private func getTitle(_ errorType: ErrorType) -> String? {
        switch errorType {
        case .internet:
            return NetworkingConstants.INTERNET_ERROR_TITLE
        case .serverTimeout:
                return NetworkingConstants.SERVER_TIMEOUT_ERROR_TITLE
        case .auth:
                return NetworkingConstants.AUTH_ERROR_TITLE
            default:
                break
        }
        return NetworkingConstants.INTERNET_ERROR_TITLE
    ...
    private func getButtonText(_ errorType: ErrorType) -> String? {
//        switch errorType {
...
//        }
    ...
    private func getMessage(_ errorType: ErrorType, error: Error?) -> String? {
        switch errorType {
        case .internet:
            return NetworkingConstants.INTERNET_ERROR_MESSAGE
        case .serverTimeout:
            return NetworkingConstants.SERVER_TIMEOUT_ERROR_MESSAGE
        case .auth:
            return NetworkingConstants.AUTH_ERROR_MESSAGE
        default:
            break
        }
        return NetworkingConstants.INTERNET_ERROR_MESSAGE
    ...
    private func handleClick(_ errorType: ErrorType) {
        switch errorType {
        case .auth:
            handleLogout()
    ...
    private func showAlert(_ title: String?, withMessage message: String?, withBtnText btnTxt: String?, errorType: ErrorType, withGif gif: URL?) {
...
//        }
    ...
    private func handleRetryClick(_ errorType: ErrorType) {
