...
//#import "User.h"
#import "UserPropertyModel.h"
#import "ServerUserPropertiesFetchedListener.h"
//#import "BI-Swift.h"

@interface UserDefaultsUtil () {
    NSUserDefaults *standardUserDefaults;
    ServerUserPropertiesUtil *serverUserPropertiesUtil;
}
@end
...
+ (id)sharedInstance {
    static UserDefaultsUtil *sharedUserDefaults = nil;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        serverUserPropertiesUtil = [[ServerUserPropertiesUtil alloc] init];
    }
    return self;
}
...
- (void)updateFromServerUserProperties {
    [serverUserPropertiesUtil getServerUserProperties:^(NSArray<UserPropertyModel> *userProperties) {
        if (userProperties != nil) {
            for (UserPropertyModel *userProperty in userProperties) {
