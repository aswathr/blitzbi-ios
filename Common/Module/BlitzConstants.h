...
static NSString * _Nonnull const BLITZ_APP_SPECIFIC_DEVICE_ID_KEY  = @"BLITZ_APP_SPECIFIC_DEVICE_ID_KEY";
static NSString * _Nonnull const BLITZ_APP_SPECIFIC_USER_ID_KEY  = @"BLITZ_APP_SPECIFIC_USER_ID_KEY";
